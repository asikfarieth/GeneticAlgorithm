...
class Genome():
    ...
    def get_gene_spec():
        gene_spec =  {"link-shape":{"scale":1},
            "link-length": {"scale":4}, # increased from 2 to 3
            "link-radius": {"scale":1.5 }, #increased from 1 to 1.5
            "link-recurrence": {"scale":3},
            "link-mass": {"scale":2}, #increased from 1 to 2
            "joint-type": {"scale":1},
            ...
            "joint-origin-xyz-1":{"scale":1}, #increased from 1 to 1.5
            "joint-origin-xyz-2":{"scale":1}, # increased from 1 to 2
            "joint-origin-xyz-3":{"scale":1}, #increased from 1 to 2
            "control-waveform":{"scale":1},
            "control-amp":{"scale":0.25}, # increased from 0.25 to 0.5
